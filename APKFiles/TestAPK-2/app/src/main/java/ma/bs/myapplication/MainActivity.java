...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyD-ExampleKey";
    private static final String HARDCODED_PASSWORD = "superSecretPassword123";
    ...
    private void testWeakCrypto() {
        try {
            ...
            // VULNERABILITY: Insecure Cipher Mode (AES/ECB)
